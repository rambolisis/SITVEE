<?php
    ...
    $cliente = $mysqli->query ("INSERT INTO administrador(id_Administrador, nombre, correo, id_Usuario) VALUES ('','$nombreAdministrador','$emailAdministrador','$mysqli->insert_id')");
