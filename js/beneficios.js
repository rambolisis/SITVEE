...
$(document).ready(function () {
    ...
    $('#adicionar').click(function () {
        ...
        var fila = '<tr id="row' + i + '"><td>' + beneficio + '</td><td>' + cantidad + '</td><td class="d-flex align-items-center justify-content-center"><button  type="button" name="remove" id="' + i + '" class="btn btn-danger btn_remove" onclick="hideRow(event)">Quitar</button></td></tr>'; //esto seria lo que contendria la fila
